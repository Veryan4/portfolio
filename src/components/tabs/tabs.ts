          ...
          ${this.selectedTab == Tab.projects ? html`
            <div class="cards-wrap">
              <div class="card" @click=${() => window.open("https://truba.news")}>
                <div
                  class="card-image truba"
                >
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1205 400" enable-background="new 0 0 1205 400">
                  <g id="truba">
              ...
              <div class="card" @click=${() => window.open("https://github.com/Veryan4/lit-spa")}>
                <div
                  class="card-image"
                  style='background-image: url("/lit-spa.png");height: 100px;'
                ></div>
                <div
                  class="card-description"
                >
                  SPA framework for WebComponents
                </div>
              </div>
